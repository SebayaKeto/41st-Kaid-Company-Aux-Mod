// ===================================================================================
// Light wall family definitions
// -----------------------------------------------------------------------------------
// This file is intended to be included under CfgVehicles from the Outpost master config.
// It defines:
// - Shared base classes (straight, curved, and entrance variants).
// - Door interaction behavior for the entrance piece.
// - Faction/skin child classes that mostly override textures + editor categories.
//
// Maintenance pattern:
// - Keep mechanics in base classes.
// - Keep visual/faction differences in derived classes only.
// ===================================================================================
class FST_OutpostWall_Base: House_F
{
	// Default editor grouping for major faction-neutral outpost assets.
	editorCategory = "FST_CatagoryMajorOutpost";
	editorSubcategory = "FST_Subcategory_OutpostWallsNeutral";

	// Hidden by default; concrete variants set scope/scopecurator to 2.
	scope = 1;
	scopecurator = 1;

	// Placement/behavior tuning for static fortification objects.
	placement = "vertical";
	mapSize = 1;
	destrType = "DestructNo";

	// Shared fallback name/model for straight light wall derivatives.
	displayName = "Light Outpost Wall (Unmarked)";
	model = "FST\FST_Outpost\LightWalls\FST_OutpostWall_Light.p3d";

	// Selection arrays must remain index-aligned across textures/materials.
...
// Base asset variants
// -----------------------------------------------------------------------------
// Curved base class used by faction-specific curve derivatives.
...
// Entrance base class adds door animation and user interaction logic.
class FST_OutpostWall_Entrance_Base: FST_OutpostWall_Base
{
	...
	// Animation source definitions bridge model anims and script/user actions.
	class AnimationSources
	{
		// Door source states are toggled by UserActions below.
		class Door_1_source
		{
			source = "user";
			initPhase = 0;
	...
	// Interaction actions for opening/closing each door leaf.
	class UserActions
	{
		class OpenDoor_1
		{
	...
	// Action aliases consumed by engine interaction handling.
	actionBegin1="OpenDoor_1";
	actionEnd1="CloseDoor_1";
	actionBegin2="OpenDoor_2";
	actionEnd2="CloseDoor_2";

	// Eden simple object behavior/state defaults for static placement preview.
	class SimpleObject
	{
		eden=1;
		animate[] =
...
// Public entrance variant with neutral/unmarked textures.
...
// -----------------------------------------------------------------------------
// Entrance skin variants
// -----------------------------------------------------------------------------
// These classes reuse entrance mechanics and only swap faction visuals/category.
...
// Public straight unmarked wall (base playable variant).
...
// GAR / Republic assets
// -----------------------------------------------------------------------------
// Straight and curved GAR variants; texture overrides differentiate regiments/camos.
...
// -----------------------------------------------------------------------------
// Pirate/Black Sun/Hutt families share the same geometry and interaction logic.
