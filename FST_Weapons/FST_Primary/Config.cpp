...
class CfgWeapons
{
	...
	class FST_DC15S_VersionTwo: Rifle_Base_F
	{
		author = "Maldova";
		scope = 2;
		displayName = "[41st] DC-15S Blaster Rifle";
		descriptionShort = "DC-15S Blaster Rifle";
		model = "\FST\FST_Weapons\FST_Primary\DC15S.p3d";
		picture = "FST\FST_Weapons\FST_Primary\Icons\DC15SIcon.paa";
		baseWeapon = "FST_DC15S_VersionTwo";
		magazineWell[] = {"FST_DC15AMagwell"};
		modes[] = {"Single","FullAuto"};
		class FullAuto: Mode_FullAuto
		{
