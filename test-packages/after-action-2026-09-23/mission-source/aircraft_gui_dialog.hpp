// ============================================================
//  aircraft_gui_dialog.hpp — 41st Kaid Bn. Star Wars Theme
...
class AircraftSpawnGUI
{
    ...
    class controls
    {
        ...
        class CamHeaderDivider: RscText
        {
            idc = 9807;
            x = "safeZoneX + safeZoneW * 0.282";
        ...
        class CamFooterDivider: RscText
        {
            idc = 9808;
            x = "safeZoneX + safeZoneW * 0.282";
        ...
        class BtnStripBorderTop: RscText
        {
            idc = 9851;
            x = "safeZoneX + safeZoneW * 0.28";
            y = "safeZoneY + safeZoneH * 0.772";
        ...
        class BtnStripBorderBottom: RscText
        {
            idc = 9852;
            x = "safeZoneX + safeZoneW * 0.28";
            y = "safeZoneY + safeZoneH * 0.948";
        ...
        class BtnStripBorderLeft: RscText
        {
            idc = 9853;
            x = "safeZoneX + safeZoneW * 0.28";
            y = "safeZoneY + safeZoneH * 0.772";
        ...
        class BtnStripBorderRight: RscText
        {
            idc = 9854;
            x = "safeZoneX + safeZoneW * 0.948";
            y = "safeZoneY + safeZoneH * 0.772";
        ...
        class SelectedVehicleBG: RscText
        {
            idc = 9855;
            x = "safeZoneX + safeZoneW * 0.282";
        ...
        class SelectedVehicleLabel: RscText
        {
            idc = 9856;
            x = "safeZoneX + safeZoneW * 0.285";
        ...
        class DeployBtn: RscButton
        {
            ...
            sizeEx = "(safeZoneH / 46)";
            font = "PuristaBold";
            action = "[] call aircraft_deploy;";
        };
        class GarageBtn: RscButton
        {
            idc = 9922;
        ...
        class CloseBtn: RscButton
        {
            ...
            sizeEx = "(safeZoneH / 48)";
            font = "PuristaBold";
            action = "call fnc_destroyPadCamera; closeDialog 0;";
        };

        class BtnHintsBG: RscText
        {
            idc = 9857;
            x = "safeZoneX + safeZoneW * 0.282";
