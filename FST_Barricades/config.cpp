...
class CfgVehicles
{
	...
	class FST_Barricade_SecurityBarrier: FST_Barricade_SecurityBarrier_Base
	{
		...
		hiddenSelctionsMaterials[] = {"FST\FST_Barricades\Data\Textures\FSTBarrier.rvmat", "FST\FST_Common\Data\Textures\Plasteel\Steel.rvmat", "FST\FST_Barricades\Data\Textures\FSTBarrier.rvmat", "FST\FST_Barricades\Data\Textures\FSTBarrierLow.rvmat"};
	};
