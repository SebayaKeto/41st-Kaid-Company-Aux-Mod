...
The corrected full upload contains 69 files / 7,007,928,124 bytes. See raider-packaging-hotfix.json for hashes and preservation checks. An isolated Arma 3 2.22.154075 probe with CBA, JLTS and 3AS passed addon/config loading and reached engine/server initialization without the missing include. Unrelated base-mission, BattlEye and Steam warnings mean full gameplay and multiplayer validation remain outstanding. Corrective Workshop publication was verified at **2026-09-26T10:32:29Z**, with Steam upload result **OK**, content manifest **8352957141521671985**, and published size **7,007,928,124 bytes**. The locally installed Workshop Raider matches the corrected payload SHA-256. The user reports that this attempt worked. See raider-hotfix-publication-receipt.json. Live Main/HC deployment remains separate.
