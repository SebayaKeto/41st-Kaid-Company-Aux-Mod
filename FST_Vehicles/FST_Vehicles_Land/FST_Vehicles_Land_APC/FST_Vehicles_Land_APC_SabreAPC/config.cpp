...
class CfgVehicles
{
	...
	class FST_Vehicle_Land_Base: Tank_F
	{
		...
		class Sounds
		{
			class EngineOnExt
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineOn.ogg",2,1,600};
				frequency = "0.85 + ((rpm / 2640) factor[(0 / 2640),(850 / 2640)]) * 0.15";
				volume = "engineOn*camPos*((rpm / 2640) factor[(0 / 2640),(300 / 2640)])*((rpm / 2640) factor[(850 / 2640),(650 / 2640)])";
			};
			class EngineOnInt
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineOn.ogg",1.4,1};
				frequency = "0.78 + ((rpm / 2640) factor[(0 / 2640),(850 / 2640)]) * 0.12";
				volume = "0.7*engineOn*(1-camPos)*((rpm / 2640) factor[(0 / 2640),(300 / 2640)])*((rpm / 2640) factor[(850 / 2640),(650 / 2640)])";
			};
			class EngineOffExt
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineOff.ogg",2,1,600};
				frequency = "0.90 + ((rpm / 2640) factor[(0 / 2640),(850 / 2640)]) * 0.10";
				volume = "(1-engineOn)*camPos*((rpm / 2640) factor[(0 / 2640),(700 / 2640)])";
			};
			class EngineOffInt
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineOff.ogg",1.4,1};
				frequency = "0.80 + ((rpm / 2640) factor[(0 / 2640),(850 / 2640)]) * 0.10";
				volume = "0.7*(1-engineOn)*(1-camPos)*((rpm / 2640) factor[(0 / 2640),(700 / 2640)])";
			};
			class Idle_ext
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdle.ogg",2.4,1,480};
				frequency = "0.95 + ((rpm/ 2640) factor[(400/ 2640),(900/ 2640)])*0.05";
				volume = "engineOn*camPos*(((rpm/ 2640) factor[(100/ 2640),(200/ 2640)]) * ((rpm/ 2640) factor[(900/ 2640),(700/ 2640)]))";
			};
			class Engine
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdle.ogg",2.2,1,550};
				frequency = "0.98 + ((rpm/ 2640) factor[(700/ 2640),(1100/ 2640)])*0.05";
			...
			class Idle_int
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdleInternal.ogg",3.3,1};
				frequency = "0.95 + ((rpm/ 2640) factor[(400/ 2640),(900/ 2640)])*0.05";
			...
			class Engine4_int
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdleInternal.ogg",2.2,1};
				frequency = "1.10 + ((rpm/ 2640) factor[(1800/ 2640),(2300/ 2640)])*0.05";
				volume = "engineOn*(1-camPos)*(((rpm/ 2640) factor[(1780/ 2640),(2060/ 2640)]) * ((rpm/ 2640) factor[(2450/ 2640),(2200/ 2640)]))";
			};
			class Engine5_int
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdleInternal.ogg",2.5,1};
				frequency = "1.125 + ((rpm/ 2640) factor[(2100/ 2640),(2640/ 2640)])*0.05";
			...
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdleInternal.ogg",4,1};
				frequency = "1.07 + ((rpm/ 2640) factor[(1500/ 2640),(2100/ 2640)])*0.05";
			...
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdleInternal.ogg",4.48808,1};
				frequency = "1.10 + ((rpm/ 2640) factor[(1800/ 2640),(2300/ 2640)])*0.05";
			...
			{
				sound[] = {"FST\FST_Sounds\Weapons\TX180_EngineIdleInternal.ogg",5.0357,1};
				frequency = "1.125 + ((rpm/ 2640) factor[(2100/ 2640),(2640/ 2640)])*0.05";
		...
		waterLeakiness=0;
		waterSpeedFactor=1.25;
		waterAngularDampingCoef=0.35;
		waterLinearDampingCoefX=0.08;
		waterLinearDampingCoefY=0.12;
		engineShiftY=0.8;
