...
#define MEC_TAG MEC             // Global tag for CfgFunctions (e.g., MEC_fnc_initializeMECPebble)
#define MEC_PREFIX MEC_              // Item/Class prefix (e.g., MEC_PB1_Item)
...
#define MEC_ELECTRICITY_PATH_GENERICDEFINES MEC_ELECTRICITY_PATH\MEC_generic_power_management.sqf
