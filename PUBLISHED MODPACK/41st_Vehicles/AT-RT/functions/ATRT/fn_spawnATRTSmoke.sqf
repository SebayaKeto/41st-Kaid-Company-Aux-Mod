 ...
 *
 * Example:
 * atrt call FST_fnc_spawnATRTSmoke;
 */
...
for "_i" from 0 to 1 do
{
    ...
    _smoke setParticleClass "3AS_Cloudlet_ATRT_Smoke";
    ...
    private _allEffects = _atrt getVariable ["FST_ATRT_effects", []];
    _allEffects pushBack _effect;
    _atrt setVariable ["FST_ATRT_effects", _allEffects];
};