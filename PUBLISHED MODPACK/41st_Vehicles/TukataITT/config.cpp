...
class CfgVehicles
{
	...
	class FST_JMSLLTE_veh_ITT_base: Car_F
	{
		author="JMax";
		model="\JMSLLTE_veh_gr_m\ITT\ITT";
		picture="\JMSLLTE_veh_gr\ITT\data\pic_ITT.paa";
		Icon="\JMSLLTE_veh_gr\ITT\data\ico_ITT.paa";
		_generalMacro="JMSLLTE_veh_ITT_base";
		displayName="K79-S80 (troop)";
		...
		class Damage
		{
			...
			mat[]=
			{
				"JMSLLTE_veh_gr\ITT\data\ITT_head.rvmat",
				"JMSLLTE_veh_gr\ITT\data\ITT_head_damage.rvmat",
				"JMSLLTE_veh_gr\destruct.rvmat",
				"JMSLLTE_veh_gr\ITT\data\ITT_mid.rvmat",
				"JMSLLTE_veh_gr\ITT\data\ITT_mid_damage.rvmat",
				"JMSLLTE_veh_gr\destruct.rvmat",
				"JMSLLTE_veh_gr\ITT\data\ITT_back.rvmat",
				"JMSLLTE_veh_gr\ITT\data\ITT_back_damage.rvmat",
				"JMSLLTE_veh_gr\destruct.rvmat",
		...
		class TextureSources
		{
			class Tex_ITT_base
			{
				...
				textures[]=
				{
					"\JMSLLTE_veh_gr\ITT\data\ITT_head_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_mid_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_back_co.paa"
				};
			};
			class Tex_ITT_baseM: Tex_ITT_base
			{
				displayName="Base grey (marks)";
				author="JMax";
				textures[]=
				{
					"\JMSLLTE_veh_gr\ITT\data\ITT_head_m_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_mid_m_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_back_m_co.paa"
				};
			};
			class Tex_ITT_jinata: Tex_ITT_base
			{
				displayName="Jinata Security";
				author="JMax";
				textures[]=
				{
					"\JMSLLTE_veh_gr\ITT\data\ITT_head_jinata_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_mid_jinata_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_back_jinata_co.paa"
				};
			};
			class Tex_ITT_rebels: Tex_ITT_base
			{
				displayName="Rebel Alliance";
				author="JMax";
				textures[]=
				{
					"\JMSLLTE_veh_gr\ITT\data\ITT_head_reb_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_mid_reb_co.paa",
					"\JMSLLTE_veh_gr\ITT\data\ITT_back_reb_co.paa"
				};
			};
		};
		textureList[]=
		...
		class AnimationSources: AnimationSources
		{
			...
			{
				source="ammorandom";
				weapon="JMSLLTE_vg_ax40_ITT_cannon";
			};
			class ReloadAnim
			{
	...
	class FST_JMSLLTE_I_veh_ITT_jinata_F: FST_JMSLLTE_veh_ITT_base
	{
		author="JMax";
		scope=2;
		scopeCurator=2;
