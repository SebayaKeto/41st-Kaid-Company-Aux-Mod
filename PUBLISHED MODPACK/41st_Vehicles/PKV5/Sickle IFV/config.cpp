...
class CfgVehicles
{
	...
	class FST_PKV5_Sickle_Base: Tank_F
	{
		vehicleClass="Armored";
		displayName="[41st] PK-V5 Fighter Tank (IFV)";
		accuracy=0.30000001;
		model="\PKV5\Up-PK-V5 Sickle\PK_V5_Sickle.p3d";
		...
		{
			"\41st_Vehicles\PKV5\Data\Fighter_Tank_Chassis_co.paa",
			"\41st_Vehicles\PKV5\Data\Multi_purpose_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"\PKV5\Data\Fighter_Tank_Chassis.rvmat",
			"\PKV5\Data\Multi_purpose.rvmat"
		};
		class TextureSources
		{
			class AMT_Republic_AAA
			{
				...
				textures[]=
				{
					...
					"\PKV5\Data\Multi_purpose_co.paa"
				};
				factions[]=
				{
					"BLU_F"
	...
	class FST_PKV5_UP_Sickle: FST_PKV5_Sickle_Base
	{
		scope=2;
		scopeCurator=2;
		displayName="[41st] PK-V5 'Sickle' IFV";
		accuracy=1.3;
		side=1;
		faction = "FST_Faction";
