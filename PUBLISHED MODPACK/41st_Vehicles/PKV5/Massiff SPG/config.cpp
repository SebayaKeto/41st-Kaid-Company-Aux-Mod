...
class CfgVehicles
{
	...
	class FST_UP_PKV5_Sceptre_Base: Tank_F
	{
		vehicleClass="Armored";
		displayName="PK-V5 'Up-Sceptre'";
		accuracy=0.30000001;
		artilleryScanner=1;
		model="\PKV5\Up-PK-V5 Sceptre\PK_V5_Sceptre.p3d";
...
/*					"FST_8Rnd_82mm_Mo_Flare_white",
		...
		hiddenSelectionsTextures[]=
		{
			...
			"\41st_Vehicles\PKV5\Data\FST_PKV5_Mortar.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"\PKV5\Data\Fighter_Tank_Chassis.rvmat",
			"\PKV5\Data\Mortar.rvmat"
		};
	...
	class FST_PKV5_UP_Sceptre: FST_UP_PKV5_Sceptre_Base
	{
		scope=2;
		scopeCurator=2;
		displayName="[41st] PK-V5 'Massif' SPG";
		accuracy=1.3;
		side=1;
		faction = "FST_Faction";
