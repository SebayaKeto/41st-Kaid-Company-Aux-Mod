...
class CfgVehicles
{
	...
	class FST_PK_V5_MLRS_Carrier_UP: Tank_F
	{
		...
		displayName="[41st] PK-V5 MLRS Carrier";
		accuracy=0.30000001;
		artilleryScanner=1;
		class SimpleObject;
		class EventHandlers
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				missileBeg="MissileE3";
				missileEnd="MissileS3";
				memoryPointMissile="[""MissileS1"",""MissileS7""]";
				memoryPointMissileDir="[""MissileE1"",""MissileE7""]";
				weapons[]=
				{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"\41st_Vehicles\PKV5\Data\FST_PKV5_MLRS.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"\PKV5\Data\Fighter_Tank_Chassis.rvmat",
			"\PKV5\Data\MLRS.rvmat"
		};
		class TextureSources
		{
			class AMT_Republic_MLRS
			{
	...
	class FST_PKV5_MLRS_Carrier: FST_PK_V5_MLRS_Carrier_UP
	{
		scope=2;
		scopeCurator=2;
		displayName="[41st] PK-V5 'Dianoga' MLRS";
		accuracy=1000;
		side=1;
		faction = "FST_Faction";
