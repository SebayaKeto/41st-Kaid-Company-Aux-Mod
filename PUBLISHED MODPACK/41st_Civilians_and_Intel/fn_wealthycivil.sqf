...
private _list_41civloads_female = [
	...
	[[],[],[],["JMSLLTE_PirCapt_hond_F_CombatUniform",[[ _pocket0, _rollhigh0],[ _pocket1, _rollhigh1],[ _pocket2, _rollmid0],[ _datapad0,1],[ _datapad1,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],[ _intelitem3,1],["JLTS_intel_holoProjector",1],[ _case0,1]]],[],[],"FST_Invisible_Civ_Helm","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],
	
	[[],[],[],["JMSLLTE_PirCapt_black_F_CombatUniform",[[ _pocket0, _rollhigh0],[ _pocket1, _rollhigh1],[ _pocket2, _rollmid0],[ _datapad0,1],[ _datapad1,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],[ _intelitem3,1],["JLTS_intel_holoProjector",1],[ _case0,1]]],[],[],"FST_Invisible_Civ_Helm","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["U_C_FormalSuit_01_tshirt_gray_F",[[ _pocket0, _rollmid0],[ _pocket1, _rollhigh0],[ _datapad0,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],["FST_CreditChip",1]]],[],[],"FST_Invisible_Civ_Helm","G_Squares_Tinted",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["U_C_FormalSuit_01_tshirt_black_F",[[ _datapad0,1],[ _datapad1,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],["JLTS_intel_holoProjector",1],["JLTS_droidCaller",1]]],["FST_Vest_Base",[[ _case0,1],[ _case1,1]]],[],"FST_Invisible_Civ_Helm","OPTRE_HUD_r_Glasses",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["OPTRE_Ins_ER_rolled_OD_crimson",[[ _datapad0,1],["JLTS_drugs_deathstick", _rolllow0],[ _intelitem0,1]]],[],["JLTS_Clone_belt_bag",[["JLTS_sabacc_deck",1],["JLTS_pazaak_deck",1],[ _rich0, _rollmid0],[ _rich1, _rollmid1],[ _pocket0, _rollhigh0],[ _pocket1, _rollhigh1],[ _pocket2, _rollmid2],[ _case0,1]]],"FST_Invisible_Civ_Helm","G_JMSLLTE_WeqGlas",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["OPTRE_Ins_URF_Combat_Flat_Uniform",[[ _pocket0, _rollhigh0],[ _rich0, _rollmid0],[ _datapad0,1],["FST_CreditChip",1],[["Knife_m3","","","",[],[],""],1]]],[],[],"H_Beret_blk","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["JMSLLTE_ScumCommando_green_F_CombatUniform",[[ _pocket0, _rollhigh0],[ _pocket1, _rollhigh1],[ _datapad0,1],[ _datapad1,1],["JLTS_droidCaller",1],["FST_CreditChip",1],[ _rich0, _rolllow0]]],[],["OPTRE_ONI_Researcher_Suitcase",[[ _case0,1],[ _case1,1],[ _intelitem0,1],[ _intelitem1,1]]],"FIR_GroundCrew_Headset","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["JMSLLTE_RoyalG_black_F_CombatUniform",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _datapad0,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],[ _intelitem0,1],[ _intelitem1,1]]],[],[],"FST_Invisible_Civ_Helm","G_Bandanna_blk",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["U_C_E_LooterJacket_01_F",[[ _pocket0, _rollmid0],[ _pocket1, _rollmid1],[ _datapad0,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],[ "FST_CreditChip",1],["JLTS_drugs_protein", _rollhigh0],[["Knife_m3","","","",[],[],""],1]]],[],[],"FST_Invisible_Civ_Helm","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]]
...
private _list_41civloads_alien = [
	...
	[[],[],[],["U_C_FormalSuit_01_tshirt_gray_F",[[ _pocket0, _rollmid0],[ _pocket1, _rollhigh0],[ _datapad0,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],["FST_CreditChip",1]]],[],[],"FST_Invisible_Civ_Helm","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["U_C_FormalSuit_01_tshirt_black_F",[[ _datapad0,1],[ _datapad1,1],[ _rich0, _rolllow0],[ _rich1, _rolllow1],["JLTS_intel_holoProjector",1],["JLTS_droidCaller",1]]],["FST_Vest_Base",[[ _case0,1],[ _case1,1]]],[],"FST_Invisible_Civ_Helm","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["OPTRE_Ins_ER_rolled_OD_crimson",[[ _datapad0,1],["JLTS_drugs_deathstick", _rolllow0],[ _intelitem0,1]]],[],["JLTS_Clone_belt_bag",[["JLTS_sabacc_deck",1],["JLTS_pazaak_deck",1],[ _rich0, _rollmid0],[ _rich1, _rollmid1],[ _pocket0, _rollhigh0],[ _pocket1, _rollhigh1],[ _pocket2, _rollmid2],[ _case0,1]]],"FST_Invisible_Civ_Helm","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],
