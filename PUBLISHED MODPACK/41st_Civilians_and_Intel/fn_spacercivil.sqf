...
[_unit, "Spacer"] remoteExec ["setName", 0, _unit];
...
private _list_41civloads_female = [
	...
	[[],[],[],["TCGM_F_Soldier_GEN_RollUp",[[ _pocket0, _rollhigh0],[ _pocket1, _rolllow0],[ _pocket2, _rollmid0],[ _datapad0,1],[ _rich0,1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],["ACE_Chemlight_UltraHiOrange",3,1]]],["JMSLLTE_c_GenVest_blue",[["WBK_HandFlashlight",1],["ls_holoprojector_bountyPuck",1],["FST_blaster_cell_SSP_Yellow",5,15],[["FST_DT12_Pistol","","","",[],[],""],1]]],[],"FST_Invisible_Civ_Helm","G_Tactical_Clear",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],
...
private _list_41civloads_hidden = [
	...
	[[],[],[],["U_B_PilotCoveralls",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _rich0,1],["FST_CreditChip",1],["JLTS_drugs_deathstick", _rolllow2],["JLTS_pazaak_deck",1]]],[],["DBA_Snowpack_Base",[[ _datapad0,1],["WBK_HeadLampItem_Double",1],["ls_holoprojector_bountyPuck",2],["FST_blaster_cell_low_yellow", _rollhigh0,30],["FST_blaster_cell_low_Yellow_smg", _rollmid0,120],[ _intelitem0,1],[ _intelitem1,1],[["IDA_VibroKnife","","","",[],[],""],1],[["FST_DH42_Pistol","","","",[],[],""],1],[["FST_EE4","","","",[],[],""],1]]],"JMSLLTE_MercSphere_white_helmet","3AS_G_Imperial_Army_Helmet_Mask_ISB_F",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["JMSLLTE_BHcom_green_F_CombatUniform",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _pocket2, _rolllow2],["ItemcTabHCam",1],["WBK_HeadLampItem_Narrow",1],["JLTS_drugs_stimulant_adrenal",1],["JLTS_drugs_deathstick", _rolllow3],["JLTS_drugs_electrolit",1],["FST_blaster_cell_low_yellow",5,30],[["FST_DL18_Pistol","","","",[],[],""],1]]],[],["FST_Backpack_Antenna_Woodland",[[ _datapad0,1],[_datapad1,1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],[ _intelitem3,1]]],"H_HelmetO_ViperSP_ghex_F","G_JMSLLTE_JinataTranslator",[],["ItemMap","","","ItemCompass","ItemWatch",""]],

	[[],[],[],["U_O_V_Soldier_Viper_hex_F",[["3AS_FlamerFuel",2,45],["3AS_FusionCutter_Splice_Magazine",2,100]]],["k_scout_pouches_heavy_desert2",[[ _datapad0,1],[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _pocket2, _rollhigh0],["FST_CreditChip",1],["JLTS_drugs_electrolit",2],[ _intelitem0,1],["WBK_HeadLampItem_Narrow",1],["ItemcTabHCam",1],["ls_holoprojector_bountyPuck",1],["ToolKit",1]]],[],"JMSLLTE_MercDisk_yel_helmet","G_JMSLLTE_TrooperMask_1_black",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["U_O_R_Gorka_01_black_F",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _rich0,1],[ _datapad0,1],["WBK_HeadLampItem_Long",1],["ItemcTabHCam",1],["JLTS_intel_holoProjector",1],[ _intelitem0,1],[ _intelitem1,1]]],["V_RebreatherB",[]],[],"JMSLLTE_MercDisk_black_helmet","",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["U_O_V_Soldier_Viper_F",[[ _pocket0, _rollmid0],[ _pocket1, _rollhigh0],[ _datapad0,1],[ _rich0,1],["ItemcTabHCam",1],[ _intelitem0,1]]],["V_RebreatherIA",[]],["3AS_B_Imperial_Stormtrooper_Backpack_Respirator_2_F",[["3AS_FlamerFuel",4,45]]],"H_PilotHelmetFighter_I_E","",[],["ItemMap","","","ItemCompass","ItemWatch",""]],

	[[],[],[],["U_C_Driver_1_white",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],["FST_CreditChip",1],[ _datapad0,1],["JLTS_intel_holoProjector",1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1]]],[],["3AS_B_ColdAssault_Backpack",[["JLTS_pazaak_deck",1],["WBK_HeadLampItem_Long",1],["ItemcTabHCam",1],["ToolKit",1],["ACE_Chemlight_HiWhite",5,1],["FST_blaster_cell_SSP_Yellow",4,15],[["FST_DC15P","","","",[],[],""],1]]],"JMSLLTE_MercLegio_grey_helmet","3AS_G_Marksman_6_F",[],["ItemMap","","","ItemCompass","ItemWatch","IDA_41st_Clone_NVG_flipped"]],

	[[],[],[],["JMSLLTE_GuavBlack_F_CombatUniform",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _datapad0,1],["FST_CreditChip",2],["JLTS_drugs_electrolit",1],["JLTS_intel_holoProjector",1],[ _intelitem0,1],[ _intelitem1,1],[ _intelitem2,1],["JLTS_droidCaller",1],["WBK_HeadLampItem_Double",1],["ItemcTabHCam",1],["ls_holoprojector_bountyPuck",1],[["WBK_SciFi_Sword_4","","","",[],[],""],1]]],[],["JMSLLTE_back_magmapack_v1",[["3AS_FusionCutter_Splice_Magazine",4,100],["3AS_FlamerFuel",4,45]]],"JMSLLTE_MercSphere_black_helmet","OPTRE_CBRN",[],["ItemMap","","","ItemCompass","ItemWatch","k_nvg_ti"]],

	[[],[],[],["ls_mandalorianUniform_traditionalWoman",[[ _pocket0, _rolllow0],[ _pocket1, _rolllow1],[ _datapad0,1],[ _intelitem0,1],[ _intelitem1,1],[["IDA_VibroKnife","","","",[],[],""],1]]],["ls_vest_holster_maroon",[[ _intelitem2,1],["FST_blaster_cell_low_yellow",4,30],[["FST_A180","","","",[],[],""],1]]],["JMSLLTE_back_jumppack_black",[["3AS_FlamerFuel",4,45]]],"ls_mandalorianHelmet_stalker","ls_glasses_scarf",[],["ItemMap","","","ItemCompass","ItemWatch","OPTRE_NVG_UL"]]
