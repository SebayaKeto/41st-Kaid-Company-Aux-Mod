...
private _list_41civdatapad = [
	...
	"FST_CivMiniData_Broken", 0.3,
	"FST_CivMiniData_Built", 0.05,
	"FST_CivMiniData_Diagnose", 0.05,
...
private _list_41civintelitems = [
	...
	"FST_CivHoloprojector_Normal", 0.1,
	"FST_CivHoloprojector_Abnormal", 0.04,
	"FST_CivHoloprojector_Alien", 0.05,
	"FST_CivHoloprojector_Beast", 0.05,
	"FST_CivHoloprojector_Broken", 0.3,
	"FST_CivHoloprojector_Empty", 0.3,
	"FST_CivHoloprojector_Galaxy", 0.05,
	"FST_CivHoloprojector_Game", 0.05,
	"FST_CivHoloprojector_Ha", 0.05,
	"FST_CivHoloprojector_Land", 0.05,
	"FST_CivHoloprojector_Manual", 0.05,
	"FST_CivHoloprojector_Map", 0.05,
	"FST_CivHoloprojector_Movie", 0.05,
	"FST_CivHoloprojector_OwO", 0.1,
