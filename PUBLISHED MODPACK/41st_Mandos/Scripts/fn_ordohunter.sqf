...
["FST_applyName", [ _unit, "Clan Ordo Hunter"]] call CBA_fnc_globalEvent;
...
if ( _loadoutchoice == 1) then { _unit setUnitLoadout [["FST_DW32S","","","",["FST_DW32S_Mag_Green",20],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["FST_DW32S_Mag_Green",15,20],["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 2) then { _unit setUnitLoadout [["FST_DL63","","","",["FST_blaster_cell_High_Green",40],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_High_Green",15,40]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 3) then { _unit setUnitLoadout [["FST_Verpine","","","",["FST_blaster_cell_High_Green",40],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_High_Green",15,40]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
