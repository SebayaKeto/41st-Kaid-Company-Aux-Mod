...
["FST_applyName", [ _unit, "Clan Ordo Coordinator"]] call CBA_fnc_globalEvent;
...
if ( _loadoutchoice == 1) then { _unit setUnitLoadout [["FST_EE3","","","JMSLLTE_ee3_bl_Scope",["FST_blaster_cell_High_Green",40],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["ls_mandalorianBackpack_radio",[["FST_blaster_cell_low_Green",15,30],["FST_blaster_cell_High_Green",15,40]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 2) then { _unit setUnitLoadout [["FST_Galaar15","","","",["FST_blaster_cell_High_Green",40],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["ls_mandalorianBackpack_radio",[["FST_blaster_cell_High_Green",15,40],["FST_blaster_cell_low_Green",15,30]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 3) then { _unit setUnitLoadout [["FST_Westar_M5_A","ls_muzzle_westar35s_suppressor","","ls_cows_westar35s_scope",["FST_blaster_cell_Westar_Green",60],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["ls_mandalorianBackpack_radio",[["FST_blaster_cell_low_Green",15,30],["FST_blaster_cell_Westar_Green",15,60]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 4) then { _unit setUnitLoadout [["FST_ZH73_MK2","","","ls_cows_zh73_scope",["FST_ZH73_Mag_Green",40],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["ls_mandalorianBackpack_radio",[["FST_blaster_cell_low_Green",15,30],["FST_ZH73_Mag_Green",12,40]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 5) then { _unit setUnitLoadout [["OPTRE_M6D_Carbine_Jungle_F","OPTRE_M6D_Carbine_Brake","OPTRE_M6D_Carbine_Flashlight","",["OPTRE_26Rnd_127x40_Mag_Jungle_Tracer",26],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["ls_mandalorianBackpack_radio",[["FST_blaster_cell_low_Green",15,30],["OPTRE_26Rnd_127x40_Mag_Jungle_Tracer",15,26],["OPTRE_40Rnd_127x40_Drum_Jungle_Tracer",10,40]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
...
if (local _unit && (leader group _unit) isEqualTo _unit) then {(group _unit) setFormation 'LINE';};
