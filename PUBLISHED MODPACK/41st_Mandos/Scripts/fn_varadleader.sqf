...
["FST_applyName", [ _unit, "Clan Varad Unit Leader"]] call CBA_fnc_globalEvent;
...
private _list_41mandohelmets = [
	...
	"ls_mandalorianHelmet_armorer", 0.8,
	"ls_mandalorianHelmet_executioner", 0.6,
...
private _list_41mandointelitems = [
	...
	"FST_CivDataCrystal_Abnormal", 0.5,
...
_unit addHeadgear _chosenhelmet;
