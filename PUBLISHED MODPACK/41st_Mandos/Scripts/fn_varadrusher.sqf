...
["FST_applyName", [ _unit, "Clan Varad Rusher"]] call CBA_fnc_globalEvent;
...
private _list_41mandohelmets = [
	"ls_mandalorianHelmet_elite", 0.2,
	"ls_mandalorianHelmet_armorer", 1,
	"ls_mandalorianHelmet_executioner", 2,
	"ls_mandalorianHelmet_nightowl", 0.2,
	"ls_mandalorianHelmet_stalker", 0.2,
	"ls_mandalorianHelmet_traditional", 0.2
...
if ( _loadoutchoice == 1) then { _unit setUnitLoadout [["FST_A300C","","","",["FST_blaster_scatter_cell_SBB3_Red",8],[],""],[],["WBK_SciFi_Sword_4","","","",["WBK_Cybercrystal",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2],[["Weap_melee_knife","","","",[],[],""],1]]],["ls_mandalorianBackpack_demo",[["IDA_grenade_Sonic_mag",3,1],["IDA_grenade_Smoke_mag",3,1],["DBA_UT5_x3_Grenade",2,3],["JMSLLTE_C25_HandGrenade",2,1],["JMSLLTE_dioxis_HandGrenade",2,1],["ls_grenade_n20_magazine",2,1],["FST_blaster_scatter_cell_SBB3_Red",15,8],[["IDA_VibroKnife","","","",[],[],""],2]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 2) then { _unit setUnitLoadout [["FST_ACPA","","","",["FST_blaster_scatter_cell_SBB3_Red",8],[],""],[],["WBK_SciFi_Sword_4","","","",["WBK_Cybercrystal",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2],[["Weap_melee_knife","","","",[],[],""],1]]],["ls_mandalorianBackpack_demo",[["IDA_grenade_Sonic_mag",3,1],["IDA_grenade_Smoke_mag",3,1],["DBA_UT5_x3_Grenade",2,3],["JMSLLTE_C25_HandGrenade",2,1],["JMSLLTE_dioxis_HandGrenade",2,1],["ls_grenade_n20_magazine",2,1],["FST_blaster_scatter_cell_SBB3_Red",15,8],[["IDA_VibroKnife","","","",[],[],""],2]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 3) then { _unit setUnitLoadout [["FST_SBB3","","","",["FST_blaster_scatter_cell_SBB3_Red",8],[],""],[],["WBK_SciFi_Sword_4","","","",["WBK_Cybercrystal",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2],[["Weap_melee_knife","","","",[],[],""],1]]],["ls_mandalorianBackpack_demo",[["IDA_grenade_Sonic_mag",3,1],["IDA_grenade_Smoke_mag",3,1],["DBA_UT5_x3_Grenade",2,3],["JMSLLTE_C25_HandGrenade",2,1],["JMSLLTE_dioxis_HandGrenade",2,1],["ls_grenade_n20_magazine",2,1],["FST_blaster_scatter_cell_SBB3_Red",15,8],[["IDA_VibroKnife","","","",[],[],""],2]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 4) then { _unit setUnitLoadout [["OPTRE_CQS48_Bulldog_Automatic","OPTRE_M26_LMG_Comp","","",["OPTRE_12Rnd_12Gauge_Pellets_Tracer",12],[],""],[],["WBK_SciFi_Sword_4","","","",["WBK_Cybercrystal",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2],[["Weap_melee_knife","","","",[],[],""],1]]],["ls_mandalorianBackpack_demo",[["IDA_grenade_Sonic_mag",3,1],["IDA_grenade_Smoke_mag",3,1],["DBA_UT5_x3_Grenade",2,3],["JMSLLTE_C25_HandGrenade",2,1],["JMSLLTE_dioxis_HandGrenade",2,1],["ls_grenade_n20_magazine",2,1],["OPTRE_12Rnd_12Gauge_Pellets_Tracer",15,12],[["IDA_VibroKnife","","","",[],[],""],2]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
