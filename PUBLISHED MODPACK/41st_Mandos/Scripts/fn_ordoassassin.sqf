...
["FST_applyName", [ _unit, "Clan Ordo Assassin"]] call CBA_fnc_globalEvent;
...
private _loadoutarray = [1, 2, 2, 0.5, 3, 0.9, 4, 0.9, 5, 0.9];

private _loadoutchoice = selectRandomWeighted _loadoutarray;

if ( _loadoutchoice == 1) then { _unit setUnitLoadout [["FST_DLT19_Rifle","","","",["FST_blaster_cell_Overcharged_Green",10],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_Overcharged_Green",15,10]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 2) then { _unit setUnitLoadout [["FST_DC15X","","","",["FST_blaster_cell_Overcharged_Green",10],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_Overcharged_Green",15,10]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 3) then { _unit setUnitLoadout [["FST_773Firepuncher","FST_Muzzle_774CX","","",["FST_blaster_cell_LE_Green",10],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_LE_Green",15,10]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 4) then { _unit setUnitLoadout [["FST_774CX","FST_Muzzle_774CX","","",["FST_blaster_cell_LE_Green",10],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_LE_Green",15,10]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 5) then { _unit setUnitLoadout [["FST_Gundark","","","",["FST_blaster_cell_LE_Green",10],[],""],[],["FST_Westar35_SA_Pistol","","FST_Attachment_Light_Normal_White_pistol","",["FST_pistol_westar35sa_Mag_Green",17],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoCape",[["IDA_grenade_Sonic_mag",2,1],["FST_pistol_westar35sa_Mag_Green",10,17],["FST_blaster_cell_LE_Green",15,10]]],"ls_mandalorianHelmet_ordoGrunt","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
