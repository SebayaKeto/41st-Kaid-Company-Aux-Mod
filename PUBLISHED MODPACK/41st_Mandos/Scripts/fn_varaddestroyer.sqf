...
["FST_applyName", [ _unit, "Clan Varad Destroyer"]] call CBA_fnc_globalEvent;
...
if ( _loadoutchoice == 1) then { _unit setUnitLoadout [["FST_EE3","","","JMSLLTE_ee3_bl_Scope",["FST_blaster_cell_High_Red",40],[],""],["3AS_HH12_F","","","",["3AS_MK41_AT",1],[],""],["FST_Westar35","","","",["FST_blaster_cell_low_Red",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _cam0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_CIS_Backpack_Invisible",[["FST_blaster_cell_low_Red",15,30],["FST_blaster_cell_High_Red",15,40],["3AS_MK41_AT",2,1]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 2) then { _unit setUnitLoadout [["FST_Galaar15","","","",["FST_blaster_cell_High_Red",40],[],""],["3AS_HH12_F","","","",["3AS_MK41_AT",1],[],""],["FST_Westar35","","","",["FST_blaster_cell_low_Red",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _cam0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_CIS_Backpack_Invisible",[["FST_blaster_cell_High_Red",15,40],["FST_blaster_cell_low_Red",15,30],["3AS_MK41_AT",2,1]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 3) then { _unit setUnitLoadout [["FST_Westar_M5_A","ls_muzzle_westar35s_suppressor","","ls_cows_westar35s_scope",["FST_blaster_cell_Westar_Red",60],[],""],["3AS_HH12_F","","","",["3AS_MK41_AT",1],[],""],["FST_Westar35","","","",["FST_blaster_cell_low_Red",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _cam0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_CIS_Backpack_Invisible",[["FST_blaster_cell_low_Red",15,30],["FST_blaster_cell_Westar_Red",15,60],["3AS_MK41_AT",2,1]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 4) then { _unit setUnitLoadout [["FST_ZH73_MK2","","","ls_cows_zh73_scope",["FST_ZH73_Mag_Red",40],[],""],["3AS_HH12_F","","","",["3AS_MK41_AT",1],[],""],["FST_Westar35","","","",["FST_blaster_cell_low_Red",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _cam0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_CIS_Backpack_Invisible",[["FST_blaster_cell_low_Red",15,30],["FST_ZH73_Mag_Red",12,40],["3AS_MK41_AT",2,1]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 5) then { _unit setUnitLoadout [["OPTRE_M6D_Carbine_Black_F","OPTRE_M6D_Carbine_Brake","OPTRE_M6D_Carbine_Flashlight","",["OPTRE_26Rnd_127x40_Mag_Black_Tracer",26],[],""],["3AS_HH12_F","","","",["3AS_MK41_AT",1],[],""],["FST_Westar35","","","",["FST_blaster_cell_low_Red",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _cam0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_standard",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_CIS_Backpack_Invisible",[["FST_blaster_cell_low_Red",15,30],["OPTRE_26Rnd_127x40_Mag_Black_Tracer",15,26],["OPTRE_40Rnd_127x40_Drum_Black_Tracer",10,40],["3AS_MK41_AT",2,1]]], _chosenhelmet,"",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
