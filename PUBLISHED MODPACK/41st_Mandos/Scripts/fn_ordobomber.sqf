...
["FST_applyName", [ _unit, "Clan Ordo Bomber"]] call CBA_fnc_globalEvent;
...
if ( _loadoutchoice == 1) then { _unit setUnitLoadout [["FST_SE28","","","",["FST_blaster_cell_low_Green_smg",120],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoBackpack_Heavy",[["MineDetector",1],["ACE_Clacker",1],["ACE_DefusalKit",1],["JMSLLTE_Detonitecharge_imp_Mag",3,1],["APERSMineDispenser_Mag",1,1],["FST_blaster_cell_low_Green",15,30],["FST_blaster_cell_low_Green_smg",15,120]]],"ls_mandalorianHelmet_ordoGrunt","ls_imperial_chestRigPouch",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 2) then { _unit setUnitLoadout [["FST_TL50","","JMSLLTE_acc_flashlight","",["FST_blaster_cell_Green",60],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoBackpack_Heavy",[["MineDetector",1],["ACE_Clacker",1],["ACE_DefusalKit",1],["JMSLLTE_Detonitecharge_imp_Mag",3,1],["APERSMineDispenser_Mag",1,1],["FST_blaster_cell_low_Green",15,30],["FST_blaster_cell_Green",15,60]]],"ls_mandalorianHelmet_ordoGrunt","ls_imperial_chestRigPouch",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 3) then { _unit setUnitLoadout [["FST_ACPR","","","",["FST_ACPR_Mag_Green",60],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoBackpack_Heavy",[["MineDetector",1],["ACE_Clacker",1],["ACE_DefusalKit",1],["JMSLLTE_Detonitecharge_imp_Mag",3,1],["APERSMineDispenser_Mag",1,1],["FST_blaster_cell_low_Green",15,30],["FST_ACPR_Mag_Green",15,60]]],"ls_mandalorianHelmet_ordoGrunt","ls_imperial_chestRigPouch",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
if ( _loadoutchoice == 4) then { _unit setUnitLoadout [["FST_Arkanian_Stock_F","","","",["FST_blaster_cell_Green",60],[],""],[],["FST_Westar35","","","",["FST_blaster_cell_low_Green",30],[],""],["FST_MandoUndersuitUni",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],[ _rich0,1],[ _rich1,1],[ _rich2,1],[ _case0,1],[ _datapad0,1],[ _datapad1, _padchoice],[ _device0,1],[ _device1,1],[ _intel0,1],[ _intel1, _intelchoice0],[ _intel2, _intelchoice1],["WBK_HeadLampItem_Double",1],[ _selectcomm,1],["JLTS_drugs_deathstick", _dschoice]]],["ls_mandalorianVest_ordoGrunt",[["IDA_BactaBandage",10],["IDA_BattleStim",2],["ACE_tourniquet",2],["ACE_splint",2]]],["FST_MandoBackpack_Heavy",[["MineDetector",1],["ACE_Clacker",1],["ACE_DefusalKit",1],["JMSLLTE_Detonitecharge_imp_Mag",3,1],["APERSMineDispenser_Mag",1,1],["FST_blaster_cell_low_Green",15,30],["FST_blaster_cell_Green",15,60]]],"ls_mandalorianHelmet_ordoGrunt","ls_imperial_chestRigPouch",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","","","ls_mandalorian_rangefinder"]]};
