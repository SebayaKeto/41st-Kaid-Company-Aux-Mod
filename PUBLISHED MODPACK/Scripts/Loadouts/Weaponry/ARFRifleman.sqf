...
_plyer addWeapon "FST_ARF_Electrobinoculars";
plyer addBackpack "FST_belt_bag";
...
for "_i" from 1 to 4 do {_plyer addItemToUniform "FST_blaster_cell_Blue";};
...
for "_i" from 1 to 2 do {_plyer addItemToBackpack "IDA_grenade_Smoke_mag";};
for "_i" from 1 to 2 do {_plyer addItemToBackpack "IDA_grenade_Smoke_Blue_mag_mag";};
for "_i" from 1 to 2 do {_plyer addItemToBackpack "IDA_grenade_Smoke_Red_mag_mag";};
