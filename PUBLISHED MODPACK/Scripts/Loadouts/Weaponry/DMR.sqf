...
comment "Add weapons";
_plyer addWeapon "FST_DC15LE";
_plyer addPrimaryWeaponItem "FST_blaster_cell_LE_Blue";
_plyer addPrimaryWeaponItem "FST_Optic_LEScope_DC15LE";
_plyer addPrimaryWeaponItem "3AS_Muzzle_LE_DC15A";
...
for "_i" from 1 to 12 do {_plyer addItemToVest "FST_blaster_cell_LE_Blue";};
