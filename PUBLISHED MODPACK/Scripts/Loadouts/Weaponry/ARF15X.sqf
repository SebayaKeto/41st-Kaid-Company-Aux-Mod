...
comment "Add weapons";
_plyer addWeapon "FST_DC15X";
_plyer addPrimaryWeaponItem "FST_blaster_cell_Overcharged_Blue";
_plyer addPrimaryWeaponItem "JLTS_DC15X_scope";
...
for "_i" from 1 to 12 do {_plyer addItemToVest "FST_blaster_cell_Overcharged_Blue";};
