...
for "_i" from 1 to 10 do {_plyer addItemToUniform "IDA_BattleStim";};
for "_i" from 1 to 20 do {_plyer addItemToUniform "IDA_BactaBandage";};
for "_i" from 1 to 2 do {_plyer addItemToUniform "ACE_splint";};
for "_i" from 1 to 2 do {_plyer addItemToUniform "ACE_tourniquet";};
...
for "_i" from 1 to 2 do {_plyer addItemToVest "IDA_grenade_Smoke_Purple_mag";};