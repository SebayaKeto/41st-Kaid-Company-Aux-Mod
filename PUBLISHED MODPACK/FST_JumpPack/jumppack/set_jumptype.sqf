...
(unitBackpack _unit) setVariable ["FST_jumppack_selected_jump", _newIndex, true];
...
hint parseText format ["name: %1 <br />Cost: <t color='#00FFFF'>%2</t><br />Current Energy:<t color='#aaff00'>%3</t>", _jumpName, _jumpCost, (unitBackpack _unit) getVariable ["FST_jumppack_energy", 0]];
