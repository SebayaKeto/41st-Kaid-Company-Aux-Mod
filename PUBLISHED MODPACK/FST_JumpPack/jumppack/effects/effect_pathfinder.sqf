...

{
	...
	_fireEffect setParticleClass "DBA_cloudlet_jumppack_fire_red";

	private _sparkEffect = "#particlesource" createVehicle (getPosASL _unit);
	_sparkEffect setParticleClass "DBA_cloudlet_jumppack_spark_red";
	...
	_light setLightColor [1, 0.45, .15];
