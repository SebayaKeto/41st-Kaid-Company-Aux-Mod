class CfgPatches
{
	class FST_Flags
	{
		...
		units[]=
		{
			...
			"FST_Flags_Carrier_Fynock"
		};
		weapons[]=
		{
			"FST_Flags_Placeable_Banshee",
			"FST_Flags_Placeable_Fynock"
		};
	};
};
...
class CfgVehicles
{
	...
	class FST_Flags_Carrier_Fynock: ace_flags_carrier_white
	{
		displayName="[41st] Fynock Carryable Flag";
		editorPreview="\z\ace\addons\flags\data\editorpreviews\ace_flags_carrier_black.jpg";
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture '41st_Flags\Data\FST_Flag_Fynock_Carrier_co.paa';";
			class CBA_Extended_EventHandlers: CBA_Extended_EventHandlers{};
		};
		class ACE_Actions
		{
...
class CfgWeapons
{
	...
	class FST_Flags_Placeable_Fynock: ace_flags_white
	{
		displayName="[41st] Fynock Placeable Flag";
		picture="\z\ace\addons\flags\data\pictures\red_item.paa";
		ace_flags_texture="41st_Flags\Data\FST_Flag_Fynock_Placeable_co.paa";
		ace_flags_carrier="FST_Flags_Carrier_Fynock";
		ace_flags_actionIconPlace="\z\ace\addons\flags\data\icons\place\red_place_icon.paa";
		ace_flags_actionIconCarry="\z\ace\addons\flags\data\icons\carry\red_carry_icon.paa";
	};
};
