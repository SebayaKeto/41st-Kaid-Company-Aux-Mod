...
["FST_applyName", [ _unit, "CIS Ship Captain"]] call CBA_fnc_globalEvent;
...
private _list_41hddatapad = [
	...
	"FST_SpaceData_Radio", 0.1,
	"FST_SpaceData_Squish", 0.02,
	"FST_SpaceData_SPACE", 0.1,
	...
	"FST_CivMiniData_Radio", 0.1,
	"FST_CivMiniData_Shot", 0.1,
	"FST_CivMiniData_Track", 0.1
...
private _list_41hdintelitems = [
	...
	"FST_CivHoloprojector_Record", 0.1,
...
while { _100amount > 0} do { _unit addItemToUniform "JLTS_credits_50"; _100amount = _100amount - 1;};
if ( _500choice == 1) then { _unit addItemToUniform "JLTS_credits_500"};
if ( _1000choice == 1) then { _unit addItemToUniform "JLTS_credits_1000"};
