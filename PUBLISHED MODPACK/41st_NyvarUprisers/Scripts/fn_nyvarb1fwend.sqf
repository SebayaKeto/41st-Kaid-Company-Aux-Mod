...
_unit setUnitLoadout [[ _pweaponchoice,"","","",[ _pammochoice, _proundamount],[],""],[],[],["FST_U_Nyvar_B1_Armor_Blue",[[ _pammochoice, _pammoamount, _proundamount],[ _wanted0,1],[ _wanted1, _wantchoice]]],[],[],"","",[],["ItemMap","","JLTS_droid_comlink","ItemCompass","","JLTS_NVG_droid_chip_1"]];
