...
["FST_applyName", [ _unit, "Nyvar Insurgent Operative"]] call CBA_fnc_globalEvent;
...
private _nadearray = [0, 0.4, 1, 0.7, 2, 0.1];
...
private _vestchoice = "FST_CIS_HolsterVest";
private _helmetchoice = "hold";
private _backchoice = "FST_CIS_Backpack_Invisible";
private _setchoice = floor (random 4);

if ( _setchoice == 0) then { _armorchoice = "FST_U_Nyvar_CloneTrooper_Armor"; _helmetchoice = "FST_Nyvar_P2_Helmet"; _vestchoice = "FST_vest_holster"; _backchoice = "FST_Nyvar_Backpack";};
if ( _setchoice == 1) then { _armorchoice = "FST_U_Nyvar_Tukata_Armor"; _helmetchoice = "FST_Nyvar_Tukata_Helmet"; _vestchoice = "JMSLLTE_Jinata_holster"; _backchoice = "ls_orsfBackpack_trooper";};
if ( _setchoice == 2) then { _armorchoice = "FST_U_Nyvar_Light_Armor"; _helmetchoice = "FST_Nyvar_Light_Helmet"; _backchoice = "FST_CIS_RTO_Backpack";};
if ( _setchoice == 3) then { _armorchoice = "FST_U_Nyvar_Merc_Armor"; _helmetchoice = "FST_Nyvar_Merc_Helmet"; _vestchoice = "JMSGD_InqKama_armor";};
...
private _pweparray = [0, 0.2, 1, 0.05, 2, 0.05, 3, 0.02, 4, 0.02, 5, 0.5, 6, 1];
private _sweparray = [0, 0.1, 1, 0.3, 2, 0.6];

private _ptypechoice = selectRandomWeighted _pweparray;
private _stypechoice = selectRandomWeighted _sweparray;
...
if ( _ptypechoice == 5) then { _pweaponchoice = selectRandom _list_41highwep; _pammochoice = "FST_blaster_cell_High_Red"; _proundamount = 40;};
if ( _ptypechoice == 6) then { _pweaponchoice = selectRandom _list_41westwep; _pammochoice = "FST_blaster_cell_Westar_Red"; _proundamount = 60;};
...
if ( _stypechoice == 2) then { _sweaponchoice = "FST_Westar35_SA_Pistol"; _sammochoice = "FST_pistol_westar35sa_Mag_Red"; _sroundamount = 17;};

_unit setUnitLoadout [[ _pweaponchoice,"","","",[ _pammochoice, _proundamount],[],""],[],[ _sweaponchoice,"","","",[ _sammochoice, _sroundamount],[],""],[ _armorchoice,[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50choice],["FST_CreditChip", _chipchoice],[ _selectdatapad,1],[ _selectcomm,1],[ _wanted0,1],[ _wanted1, _wantchoice],[ _intel0,1],[ _intel1,1]]],[ _vestchoice,[["IDA_BactaBandage", _rollhigh0],["IDA_BattleStim", _rolllow0],["ACE_splint", _rolllow1],["ACE_tourniquet", _rolllow2]]],[ _backchoice,[["IDA_grenade_Detonator_mag", _thermalamount,1],["IDA_grenade_Sonic_mag", _flashamount,1],["FST_grenade_smoke_orange_mag", _smokeamount,1],[ _pammochoice, _pammoamount, _proundamount],[ _sammochoice, _sammoamount, _sroundamount]]], _helmetchoice,"",[],["ItemMap","","ls_radios_hush98_aurebesh","ItemCompass","","k_nvg_ti"]];
