...
["FST_applyName", [ _unit, "Nyvar Insurgent Recruit"]] call CBA_fnc_globalEvent;
...
private _list_41nyvarintelitems = [
	...
	"FST_CivDataCrystal_Abnormal", 0.02,
	...
	"FST_CivFlimsiFile_Abnormal", 0.05,
	...
	"FST_CivHoloprojector_Abnormal", 0.05,
...
private _list_41nyvarcomms = [
	"FST_HoloComm_Normal", 0.1,
	"FST_HoloComm_Abnormal", 0.05,
	"FST_HandComm_Normal", 0.5,
	"FST_HandComm_Abnormal", 0.05,
	"FST_FlatComm_Normal", 0.5,
	"FST_FlatComm_Abnormal", 0.05,
	"", 2
...
private _list_41nyvarunis = [
	"JMSLLTE_PirShirt_red_F_CombatUniform",
	"JMSLLTE_HuttHeavy_bl_F_CombatUniform",
...
private _selectuni = selectRandom _list_41nyvarunis;
