...
["FST_applyName", [ _unit, "Umbaran Medic"]] call CBA_fnc_globalEvent;
...
private _list_41hdintelitems = [
	...
	"FST_CivHoloprojector_Anatomy", 1,
...
private _500array = [0, 0.6, 1, 0.4];
private _chiparray = [0, 0.6, 1, 0.4];
...
_unit setUnitLoadout [["FST_DH17","","","JMSLLTE_dh17_holo_Scope",["FST_blaster_cell_low_green",30],[],""],[],[],["FST_UmbaranBodysuit",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],["JLTS_credits_100", _100amount],["JLTS_credits_500", _500choice],["FST_CreditChip", _chipchoice],[ _selectdatapad,1],[ _selectcomm,1],[ _intel0,1],[ _intel1,1],[ _intel2,1]]],["FST_UmbaranVest_Med",[["FST_blaster_cell_low_green",15,30],["FST_BreathingGas_Oxygen",1]]],["FST_Umbaran_Medicpack",[["IDA_BactaBandage",20],["IDA_BattleStim",5],["ACE_splint",5],["ACE_tourniquet",5],["ACE_bloodIV",2],["ACE_bloodIV_500",1],["ACE_plasmaIV",1],["ACE_plasmaIV_500",1],["FST_Bacta_Tank",1],["IDA_Cauterizer",1]]],"OPTRE_ONI_Researcher_Headgear","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","ItemCompass","","k_nvg_ti"]];
