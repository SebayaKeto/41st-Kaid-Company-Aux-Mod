...
["FST_applyName", [ _unit, "Umbaran RTO"]] call CBA_fnc_globalEvent;
...
private _list_41hdcomms = [
	...
	"FST_HoloComm_Abnormal", 0.5,
	"FST_HandComm_Normal", 0.3,
	"FST_HandComm_Abnormal", 0.5,
	"FST_FlatComm_Normal", 0.3,
	"FST_FlatComm_Abnormal", 0.5
...
_unit setUnitLoadout [["FST_Galaar15","","","",["FST_blaster_cell_Green",60],[],""],[],[],["FST_UmbaranBodysuit",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],["JLTS_credits_100", _100choice],["FST_CreditChip", _chipchoice],[ _selectdatapad,1],[ _selectcomm,1],[ _intel0,1],[ _intel1,1],[ _intel2,1]]],["FST_UmbaranVest_Inf",[["IDA_BactaBandage", 10],["IDA_BattleStim", 5],["ACE_splint", 4],["ACE_tourniquet", 4],["FST_BreathingGas_Oxygen",1]]],["3AS_B_ColdAssault_Backpack",[["ACE_CableTie",5],["IDA_grenade_Smoke_Green_mag",3,1],["ACE_Chemlight_HiGreen",3,1],["FST_blaster_cell_Green",15,60]]],"OPTRE_ONI_Researcher_Headgear","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","ItemCompass","","k_nvg_ti"]];
