...
["FST_applyName", [ _unit, "Umbaran Marksman"]] call CBA_fnc_globalEvent;
...
_unit setUnitLoadout [["FST_773Firepuncher","FST_Muzzle_774CX","","",["FST_blaster_cell_LE_Green",10],[],""],[],[],["FST_UmbaranBodysuit",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],["JLTS_credits_100", _100choice],["FST_CreditChip", _chipchoice],[ _selectdatapad,1],[ _selectcomm,1],[ _intel0,1],[ _intel1, _intel1choice],[ _intel2, _intel2choice]]],["FST_UmbaranVest_Inf",[["IDA_BactaBandage", 10],["IDA_BattleStim", 5],["ACE_splint", 4],["ACE_tourniquet", 4],["FST_BreathingGas_Oxygen",1]]],["FST_belt_bag",[["ACE_CableTie",5],["IDA_grenade_Smoke_Green_mag",3,1],["ACE_Chemlight_HiGreen",3,1],["FST_blaster_cell_LE_Green",10,10]]],"OPTRE_ONI_Researcher_Headgear","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","ItemCompass","","k_nvg_ti"]];
