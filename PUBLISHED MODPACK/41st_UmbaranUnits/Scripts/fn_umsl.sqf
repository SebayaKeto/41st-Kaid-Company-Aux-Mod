...
["FST_applyName", [ _unit, "Umbaran Squad Commander"]] call CBA_fnc_globalEvent;
...
private _list_41hdintelitems = [
	...
	"FST_CivFlimsiFile_Abnormal", 0.5,
	...
	"FST_CivHoloprojector_Abnormal", 0.5,
...
private _list_41hdcomms = [
	"FST_HoloComm_Normal", 0.2,
	"FST_HoloComm_Abnormal", 0.6,
	"FST_HandComm_Normal", 0.2,
	"FST_HandComm_Abnormal", 0.6,
	"FST_FlatComm_Normal", 0.2,
	"FST_FlatComm_Abnormal", 0.6,
	"", 2
...
private _chiparray = [0, 0.7, 1, 0.3];
...
_unit setUnitLoadout [["FST_Galaar15","","","",["FST_blaster_cell_Green",60],[],""],[],[],["FST_UmbaranBodysuit",[["JLTS_credits_10", _10amount],["JLTS_credits_50", _50amount],["JLTS_credits_100", _100choice],["FST_CreditChip", _chipchoice],[ _selectdatapad,1],[ _selectcomm,1],[ _intel0,1],[ _intel1,1],[ _intel2,1]]],["FST_UmbaranVest_Off",[["IDA_BactaBandage", 10],["IDA_BattleStim", 5],["ACE_splint", 4],["ACE_tourniquet", 4],["FST_BreathingGas_Oxygen",1]]],["FST_belt_bag",[["ACE_CableTie",5],["JMSLLTE_dioxis_HandGrenade",2,1],["IDA_grenade_Smoke_Green_mag",3,1],["IDA_grenade_Sonic_mag",3,1],["IDA_grenade_Detonator_mag",2,1],["FST_blaster_cell_Green",15,60]]],"OPTRE_ONI_Researcher_Headgear","",[],["ItemMap","ItemGPS","ls_radios_hush98_aurebesh","ItemCompass","","k_nvg_ti"]];
