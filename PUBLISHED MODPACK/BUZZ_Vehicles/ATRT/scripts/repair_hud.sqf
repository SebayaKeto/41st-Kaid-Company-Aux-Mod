...
// ─── Colour palette (matches main HUD) ────────────────────────────────────────
...
// ─── Panel anchor — centred, lower third of screen ────────────────────────────
...
// ─── Info row column split (pct left, time right) ─────────────────────────────
...
// ─── Static text ─────────────────────────────────────────────────────────────
_cHdr  ctrlSetText "REPAIRING AT-RT";
_cHint ctrlSetText "PRESS ESC TO CANCEL REPAIR";
_cPct  ctrlSetText "0%";
_cTime ctrlSetText format ["%1s remaining", round _repairTime];
...
while {
    ...
    private _progress = (_elapsed / _repairTime) min 1.0;
    private _secsLeft = round ((_repairTime - _elapsed) max 0);
