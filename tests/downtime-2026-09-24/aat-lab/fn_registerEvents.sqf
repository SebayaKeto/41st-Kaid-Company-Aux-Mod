...
["FST_HC_evt_captureTransferState", {_this call FST_HCSpawn_fnc_captureTransferState}] call CBA_fnc_addEventHandler;
if (isServer) then {
    ["FST_HC_evt_receiveTransferState", {_this call FST_HCSpawn_fnc_receiveTransferState}] call CBA_fnc_addEventHandler;
};
// Reapply individual holds on the new owner.
