...
// Let native vehicle pathing execute Rush/Hunt. Very short continuously
// recomputed standoff waypoints fought the AAT driver's turn commands and
// could leave its rear toward the threat. Gunner assistance remains separate.
