...
// Native combat-task movement already turns the hull toward its route.
// Applying stop/turn pulses while that driver is following a task creates
// competing orders. Keep native gunner assistance above, but reserve physical
// turn pulses for an unassigned, stationary engagement.
if (_mode!="") exitWith {};
...
[FST_HCSpawn_fnc_burnsArmorPulseEnd,[_v,_token],linearConversion [55,180,abs _angle,0.15,0.4,true]] call CBA_fnc_waitAndExecute;
